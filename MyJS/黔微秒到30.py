#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# 完整脚本(蹲点自动提现)，短信登录exe等，网盘链接https://pan.quark.cn/s/e2f53c608e83，感谢老板支持
# 代理变量qwdj_proxy，刷权重开关qwdj_ad=1，提现指定金额qwdj_withdraw_amount=金额
# 账号环境变量 qwdj：备注#Bearer活动页面令牌#app令牌（分隔符 & 或换行均可）
