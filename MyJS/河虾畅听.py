...
def run_report_phase(account):
    ...
    print(f"  [{user}] Phase 1 开始: 上报 {LOOP_COUNT} 次 | {today_str}")
...
def cash_withdraw(account, amount=None):
    ...
    headers = {
        ...
        "Referer": WITHDRAW_BASE_URL + "/hexia/welfare-package/withdraw/index.html?showContentInStatusBar=1",
