 ...
 *  2.任意请求头中的Qm-User-Token
 * export yht_ck="Qm-User-Token"  多个换行
 * export yht_zl="邀请id"  多个用&分隔
 * const $ = new Env('益禾堂');
 */
const $ = new Env("益禾堂"),
  axios = require("axios"),
...
(async () => {
  ...
  const yht_zl = process.env.yht_zl;
  // const _0x533aea = checkVersion("yht.js", "69185a59f59e2339d48af04a7894f89a"); 
  const _0x533aea = "691033043055370241,559841571541866236"
  let _0x540f5a = [];
  ...
  const zhuliArr = yht_zl ? yht_zl.split("&") : '';
  _0x540f5a.push(...zhuliArr);
