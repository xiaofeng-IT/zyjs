...
class InviteAPI:
    ...
    def ai_agent_chat(self, mobile: str, content: str, agent_id: str = "", from_act: str = "cny",
                      session_id: str = "") -> dict:
        params = {
    ...
    if success_count > 0:
        ...
        stat_events = [
            ...
            ("activity_vring_make_1.9",
             f"_activityID_{ACTIVITY_ID}_templateID_{template_id}_entrance_{CHANNEL_ID}_templateconfID_{template_conf_id}_ca_AP3V"),
            ("activity_2511AI-makeonekey_1.6",
             f"activityID_{ACTIVITY_ID}_templateID_{template_id}_entrance_{CHANNEL_ID}_templateconfID_{template_conf_id}_ca_AP3V"),
