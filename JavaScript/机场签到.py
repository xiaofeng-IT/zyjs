...
v2free注册地址:  https://w1.v2free.cc/auth/register?code=5sbv
ikuuu注册地址: https://ikuuu.pw/auth/register?code=lC0r
gw树洞注册地址: https://hello36d.com/register?aff=Kk5yBfl9
...
def checkin():
    ...
    login_url = 'https://ikuuu.pw/auth/login'.format(url)
    check_url = 'https://ikuuu.pw/user/checkin'.format(url)
    header = {
        'origin': login_url,
        'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36'
    }
