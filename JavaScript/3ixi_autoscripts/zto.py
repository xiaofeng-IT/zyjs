...
脚本功能：自动登录+自动签到+自动领取补签卡
脚本版本：1.1.0
使用方法：访问网页https://auth.zto.com/m/html/login/index.html 选择密码登录，点击“忘记密码”验证手机号后设置密码。
----------------------
描述: 使用账号密码登录中通快递，自动签到获取积分；访问网页https://auth.zto.com/m/html/login/index.html 选择密码登录，点击“忘记密码”验证手机号后设置密码。
环境变量：
        变量名：ztozm
        变量值：手机号&密码，多个账号用#分隔
签到奖励：积分，可兑东西，每月自动领补签卡
"""
